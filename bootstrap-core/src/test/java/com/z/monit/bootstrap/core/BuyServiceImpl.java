...
public class BuyServiceImpl implements BuyService {
	...
	public boolean buy(String userId, BigDecimal amount, String productId) {
		...
		try {
			...
			logger.info("=monit begin,role:accept,invokeUniqueKey:" + invokeInfo.getInvokeUniqueKey() + ",parentId:"
					+ invokeInfo.getParentId() + ",currentId:" + invokeInfo.getCurrentId());
		...
		try {
			if (invokeInfo != null) {
				...
				logger.info("=monit end,role:accept,invokeUniqueKey:" + invokeInfo.getInvokeUniqueKey() + ",parentId:"
						+ invokeInfo.getParentId() + ",currentId:" + invokeInfo.getCurrentId() + ",cost:" + cost);
			}
		} catch (Exception e) {
